...
def busca_em_extensao(origem, destino):
    # fila de busca
    fila = [origem]
...
resultado = busca_em_extensao("G11", "I18")

if not resultado:
    print("Não foi encontrado um caminho!")
else:
    print("Caminho até a primeira bolinha: ", resultado)


resultado2 = busca_em_extensao("I18", "A1")
